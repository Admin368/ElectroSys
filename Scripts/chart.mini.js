...
! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).Chart = e() }(this, (function() {
    ...
    function $t(t, e, i, s = 1e-6) { return t >= Math.min(e, i) - s && t <= Math.max(e, i) + s }

    function Yt(t) { return !t || $(t.size) || $(t.family) ? null : (t.style ? t.style + " " : "") + (t.weight ? t.weight + " " : "") + t.size + "px " + t.family }

    function Ut(t, e, i, s, n) { let o = e[n]; return o || (o = e[n] = t.measureText(n).width, i.push(n)), o > s && (s = o), s }
    ...
    function Zt(t, e, i) { return i = i || .5, !e || t && t.x > e.left - i && t.x < e.right + i && t.y > e.top - i && t.y < e.bottom + i }

    function Qt(t, e) { t.save(), t.beginPath(), t.rect(e.left, e.top, e.right - e.left, e.bottom - e.top), t.clip() }

    function Jt(t) { t.restore() }
    ...
    function ce(t, e) {
        t._chartjs ? t._chartjs.listeners.push(e) : (Object.defineProperty(t, "_chartjs", { configurable: !0, enumerable: !1, value: { listeners: [e] } }), he.forEach((e => {
    ...
    function de(t, e) {
        ...
        if (!i) return;
        const s = i.listeners,
            n = s.indexOf(e); - 1 !== n && s.splice(n, 1), s.length > 0 || (he.forEach((e => { delete t[e] })), delete t._chartjs)
    }

    function ue(t) { const e = new Set; let i, s; for (i = 0, s = t.length; i < s; ++i) e.add(t[i]); return e.size === s ? t : Array.from(e) }
    ...
    function xe(t, e) { return me(t).getPropertyValue(e) }
    ...
    function we(t, e, i, s) {
        ...
        return h = Math.max(0, h - o.width), c = Math.max(0, s ? Math.floor(h / s) : c - o.height), h = ve(Math.min(h, a, l.maxWidth)), c = ve(Math.min(c, r, l.maxHeight)), h && !c && (c = ve(h / 2)), { width: h, height: c }
    }
    ...
    function Pe(t, e) { return "native" in t ? { x: t.x, y: t.y } : ye(t, e) }
    ...
    function Oe(t, e, i, s) { const n = []; if (!Zt(e, t.chartArea, t._minPadding)) return n; return Ce(t, i, e, (function(t, i, o) { t.inRange(e.x, e.y, s) && n.push({ element: t, datasetIndex: i, index: o }) }), !0), n }
    ...
    function Fe(t) { return ze(t, { top: "y", right: "x", bottom: "y", left: "x" }) }

    function Be(t) { return ze(t, ["topLeft", "topRight", "bottomLeft", "bottomRight"]) }

    function Ve(t) { const e = Fe(t); return e.width = e.left + e.right, e.height = e.top + e.bottom, e }
    ...
    function He(t, e, i) { const { min: s, max: n } = t, o = Z(e, (n - s) / 2), a = (t, e) => i && 0 === t ? 0 : t + e; return { min: a(s, -Math.abs(o)), max: a(n, o) } }

    function je(t, e) { return Object.assign(Object.create(t), e) }
    const $e = ["left", "top", "right", "bottom"];

    function Ye(t, e) { return t.filter((t => t.pos === e)) }

    function Ue(t, e) { return t.filter((t => -1 === $e.indexOf(t.pos) && t.box.axis === e)) }
    ...
    function Ke(t, e, i, s) { return Math.max(t[i], e[i]) + Math.max(t[s], e[s]) }

    function Ge(t, e) { t.top = Math.max(t.top, e.top), t.left = Math.max(t.left, e.left), t.bottom = Math.max(t.bottom, e.bottom), t.right = Math.max(t.right, e.right) }
    ...
    function ti(t, e, i, s, n) { t.top = i, t.left = e, t.right = e + s, t.bottom = i + n, t.width = s, t.height = n }
    ...
    var ii = {
        ...
        update(t, e, i, s) {
            ...
            const n = Ve(t.options.layout.padding),
                ...
                r = function(t) {
                    const e = function(t) { const e = []; let i, s, n, o, a, r; for (i = 0, s = (t || []).length; i < s; ++i) n = t[i], ({ position: o, options: { stack: a, stackWeight: r = 1 } } = n), e.push({ index: i, box: n, pos: o, horizontal: n.isHorizontal(), weight: n.weight, stack: a && o + a, stackWeight: r }); return e }(t),
                        ...
                        r = Ue(e, "x"),
                        l = Ue(e, "y");
                    return { fullSize: i, leftAndTop: s.concat(o), rightAndBottom: n.concat(l).concat(a).concat(r), chartArea: Ye(e, "chartArea"), vertical: s.concat(n).concat(l), horizontal: o.concat(a).concat(r) }
                }(t.boxes),
                l = r.vertical,
                h = r.horizontal;
            ...
            Je(r.fullSize, f, d, g), Je(l, f, d, g), Je(h, f, d, g) && Je(l, f, d, g),
                ...
                }(f), ei(r.leftAndTop, f, d, g), f.x += f.w, f.y += f.h, ei(r.rightAndBottom, f, d, g), t.chartArea = { left: f.left, top: f.top, right: f.left + f.w, bottom: f.top + f.h, height: f.h, width: f.w }, J(r.chartArea, (e => {
                    const i = e.box;
    ...
    function oi(t, e = { scriptable: !0, indexable: !0 }) { const { _scriptable: i = e.scriptable, _indexable: s = e.indexable, _allKeys: n = e.allKeys } = t; return { allKeys: n, scriptable: i, indexable: s, isScriptable: dt(i) ? i : () => i, isIndexable: dt(s) ? s : () => s } }
    const ai = (t, e) => t ? t + ht(e) : e,
        ri = (t, e) => U(e) && "adapters" !== t && (null === Object.getPrototypeOf(e) || e.constructor === Object);

    function li(t, e, i) { if (Object.prototype.hasOwnProperty.call(t, e)) return t[e]; const s = i(); return t[e] = s, s }

    function hi(t, e, i) { return dt(t) ? t(e, i) : t }
    const ci = (t, e) => !0 === t ? e : "string" == typeof t ? lt(e, t) : void 0;

    function di(t, e, i, s) { for (const n of e) { const e = ci(i, n); if (e) { t.add(e); const n = hi(e._fallback, i, e); if (ct(n) && n !== i && n !== s) return n } else if (!1 === e && ct(s) && i !== s) return null } return !1 }
    ...
    function fi(t, e, i, s) { for (; i;) i = di(t, e, i, s); return i }

    function gi(t, e) { for (const i of e) { if (!i) continue; const e = i[t]; if (ct(e)) return e } }
    ...
    function yi(t, e = "x") {
        ...
        for (a = 0; a < s; ++a)
            ...
            }! function(t, e, i) { const s = t.length; let n, o, a, r, l, h = xi(t, 0); for (let c = 0; c < s - 1; ++c) l = h, h = xi(t, c + 1), l && h && (Tt(e[c], 0, mi) ? i[c] = i[c + 1] = 0 : (n = i[c] / e[c], o = i[c + 1] / e[c], r = Math.pow(n, 2) + Math.pow(o, 2), r <= 9 || (a = 3 / Math.sqrt(r), i[c] = n * a * e[c], i[c + 1] = o * a * e[c]))) }(t, n, o),
        function(t, e, i = "x") {
            const s = bi(i),
                n = t.length;
            let o, a, r, l = xi(t, 0);
    ...
    function vi(t, e, i) { return Math.max(Math.min(t, i), e) }

    function wi(t, e, i, s, n) {
        let o, a, r, l;
        if (e.spanGaps && (t = t.filter((t => !t.skip))), "monotone" === e.cubicInterpolationMode) yi(t, n);
        else { let i = s ? t[t.length - 1] : t[0]; for (o = 0, a = t.length; o < a; ++o) r = t[o], l = _i(i, r, t[Math.min(o + 1, a - (s ? 0 : 1)) % a], e.tension), r.cp1x = l.previous.x, r.cp1y = l.previous.y, r.cp2x = l.next.x, r.cp2y = l.next.y, i = r }
        e.capBezierPoints && function(t, e) { let i, s, n, o, a, r = Zt(t[0], e); for (i = 0, s = t.length; i < s; ++i) a = o, o = r, r = i < s - 1 && Zt(t[i + 1], e), o && (n = t[i], a && (n.cp1x = vi(n.cp1x, e.left, e.right), n.cp1y = vi(n.cp1y, e.top, e.bottom)), r && (n.cp2x = vi(n.cp2x, e.left, e.right), n.cp2y = vi(n.cp2y, e.top, e.bottom))) }(t, i)
    }
    const Mi = t => 0 === t || 1 === t,
        ...
        Pi = {
            ...
            easeInOutElastic(t) { const e = .1125; return Mi(t) ? t : t < .5 ? .5 * ki(2 * t, e, .45) : .5 + .5 * Si(2 * t - 1, e, .45) },
    ...
    function Di(t, e, i, s) { return { x: t.x + i * (e.x - t.x), y: t.y + i * (e.y - t.y) } }

    function Ci(t, e, i, s) { return { x: t.x + i * (e.x - t.x), y: "middle" === s ? i < .5 ? t.y : e.y : "after" === s ? i < 1 ? t.y : e.y : i > 0 ? e.y : t.y } }
    ...
    function Ti(t, e, i) { return function(t, e) { e = e || {}; const i = t + JSON.stringify(e); let s = Ai.get(i); return s || (s = new Intl.NumberFormat(t, e), Ai.set(i, s)), s }(e, i).format(t) }

    function Li(t, e, i) { return t ? function(t, e) { return { x: i => t + t + e - i, setWidth(t) { e = t }, textAlign: t => "center" === t ? t : "right" === t ? "left" : "right", xPlus: (t, e) => t - e, leftForLtr: (t, e) => t - e } }(e, i) : { x: t => t, setWidth(t) {}, textAlign: t => t, xPlus: (t, e) => t + e, leftForLtr: (t, e) => t } }

    function Ri(t, e) { let i, s; "ltr" !== e && "rtl" !== e || (i = t.canvas.style, s = [i.getPropertyValue("direction"), i.getPropertyPriority("direction")], i.setProperty("direction", e, "important"), t.prevTextDirection = s) }

    function Ei(t, e) { void 0 !== e && (delete t.prevTextDirection, t.canvas.style.setProperty("direction", e[0], e[1])) }

    function Ii(t) { return "angle" === t ? { between: Nt, compare: Vt, normalize: Wt } : { between: $t, compare: (t, e) => t - e, normalize: t => t } }

    function zi({ start: t, end: e, count: i, loop: s, style: n }) { return { start: t % i, end: e % i, loop: s && (e - t + 1) % i == 0, style: n } }

    function Fi(t, e, i) {
        if (!i) return [t];
        const { property: s, start: n, end: o } = i, a = e.length, { compare: r, between: l, normalize: h } = Ii(s), { start: c, end: d, loop: u, style: f } = function(t, e, i) {
        ...
        const y = () => b || l(n, x, p) && 0 !== r(n, x),
            v = () => !b || 0 === r(o, p) || l(o, x, p);
        for (let t = c, i = c; t <= d; ++t) m = e[t % a], m.skip || (p = h(m[s]), p !== x && (b = l(p, n, o), null === _ && y() && (_ = 0 === r(p, n) ? t : i), null !== _ && v() && (g.push(zi({ start: _, end: t, loop: u, count: a, style: f })), _ = null), i = t, x = p));
    ...
    function Wi(t, e, i, s) {
        return s && s.setContext && i ? function(t, e, i, s) {
            ...
            for (const t of e) {
                ...
                for (u = d + 1; u <= t.end; u++) {
                    const r = i[u % l];
                    e = Ni(s.setContext(je(n, { type: "segment", p0: o, p1: r, p0DataIndex: (u - 1) % l, p1DataIndex: u % l, datasetIndex: a }))), Hi(e, c) && f(d, u - 1, t.loop, c), o = r, c = e
                }
    ...
    const Ui = { touchstart: "mousedown", touchmove: "mousemove", touchend: "mouseup", pointerenter: "mouseenter", pointerdown: "mousedown", pointermove: "mousemove", pointerup: "mouseup", pointerleave: "mouseout", pointerout: "mouseout" },
        Xi = t => null === t || "" === t;
    const qi = !!ke && { passive: !0 };

    function Ki(t, e, i) { t.canvas.removeEventListener(e, i, qi) }
    ...
    function es() {
        ...
        t !== ts && (ts = t, Ji.forEach(((e, i) => { i.currentDevicePixelRatio !== t && e() })))
    }
    ...
    function is(t, i, s) {
        ...
        return r.observe(o),
            function(t, e) { Ji.size || window.addEventListener("resize", es), Ji.set(t, e) }(t, a), r
    }

    function ss(t, e, i) { i && i.disconnect(), "resize" === e && function(t) { Ji.delete(t), Ji.size || window.removeEventListener("resize", es) }(t) }
    ...
    function ns(t, i, s) {
        ...
        return function(t, e, i) { t.addEventListener(e, i, qi) }(n, i, o), o
    }
    class os extends $i {
        acquireContext(t, e) {
            ...
            return i && i.canvas === t ? (function(t, e) {
                ...
                if (t.$chartjs = { initial: { height: s, width: n, style: { display: i.display, height: i.height, width: i.width } } }, i.display = i.display || "block", i.boxSizing = i.boxSizing || "border-box", Xi(n)) {
                    const e = Se(t, "width");
                    void 0 !== e && (t.width = e)
                }
                if (Xi(s))
    ...
    function as(t) { return !fe() || "undefined" != typeof OffscreenCanvas && t instanceof OffscreenCanvas ? Yi : os }
    ...
    function ms(t, e) { const i = t && t.options.stacked; return i || void 0 === i && void 0 !== e.stack }

    function xs(t, e, i) { const s = t[e] || (t[e] = {}); return s[i] || (s[i] = {}) }

    function bs(t, e, i, s) { for (const n of e.getMatchingVisibleMetas(s).reverse()) { const e = t[n.index]; if (i && e > 0 || !i && e < 0) return n.index } return null }
    ...
    function ys(t, e) { const i = t.scales; return Object.keys(i).filter((t => i[t].axis === e)).shift() }
    ...
    class ks {
        ...
        _update(t) {
            const e = this._cachedMeta;
            this.update(t || "default"), e._clip = function(t) { let e, i, s, n; return U(t) ? (e = t.top, i = t.right, s = t.bottom, n = t.left) : e = i = s = n = t, { top: e, right: i, bottom: s, left: n, disabled: !1 === t } }(K(this.options.clip, function(t, e, i) {
                if (!1 === i) return !1;
                const s = fs(t, i),
                    n = fs(e, i);
        ...
        getContext(t, e, i) {
            ...
            if (t >= 0 && t < this._cachedMeta.data.length) {
                ...
                n = e.$context || (e.$context = function(t, e, i) { return je(t, { active: !1, dataIndex: e, parsed: void 0, raw: void 0, element: i, index: e, mode: "default", type: "data" }) }(this.getContext(), t, e)), n.parsed = this.getParsed(t), n.raw = s.data[t], n.index = n.dataIndex = t
            } else n = this.$context || (this.$context = function(t, e) { return je(t, { active: !1, dataset: void 0, datasetIndex: e, index: e, mode: "default", type: "dataset" }) }(this.chart.getContext(), this.index)), n.dataset = s, n.index = n.datasetIndex = this.index;
        ...
        includeOptions(t, e) { return !e || ws(t) || this.chart._animationsDisabled }
        updateElement(t, e, i, s) { ws(s) ? Object.assign(t, i) : this._resolveAnimations(e, s).update(t, i) }
        updateSharedOptions(t, e, i) { t && !ws(e) && this._resolveAnimations(void 0, e).update(t, i) }
        _setStyle(t, e, i, s) {
            t.active = s;
    ...
    const Ps = {
        ...
        logarithmic(t, e, i) { if (0 === t) return "0"; const s = t / Math.pow(10, Math.floor(Pt(t))); return 1 === s || 2 === s || 5 === s ? Ps.numeric.call(this, t, e, i) : "" }
    };
    ...
    function Cs(t, e) {
        ...
        if (o > 0) { let t, i; const s = o > 1 ? Math.round((r - a) / (o - 1)) : null; for (Os(e, l, h, $(s) ? 0 : a - s, a), t = 0, i = o - 1; t < i; t++) Os(e, l, h, n[t], n[t + 1]); return Os(e, l, h, r, $(s) ? e.length : r + s), l }
        return Os(e, l, h), l
    }
    ...
    function Is(t, e, i) { let n = s(t); return (i && "right" !== e || !i && "right" === e) && (n = (t => "left" === t ? "right" : "right" === t ? "left" : t)(n)), n }
    class zs extends Ss {
        ...
        getPixelForDecimal(t) { this._reversePixels && (t = 1 - t); const e = this._startPixel + t * this._length; return jt(this._alignToPixels ? qt(this.chart, e, 0) : e) }
        ...
        getContext(t) { const e = this.ticks || []; if (t >= 0 && t < e.length) { const i = e[t]; return i.$context || (i.$context = function(t, e, i) { return je(t, { tick: i, index: e, type: "tick" }) }(this.getContext(), t, i)) } return this.$context || (this.$context = je(this.chart.getContext(), { scale: this, type: "scale" })) }
        _tickSize() {
        ...
        _computeGridLineItems(t) {
            ...
            for (m = 0; m < l; m += C) {
                ...
                x = Ls(this, m, a), void 0 !== x && (b = qt(i, x, e), r ? _ = v = M = S = b : y = w = k = P = b, c.push({ tx1: _, ty1: y, tx2: v, ty2: w, x1: M, y1: k, x2: S, y2: P, width: e, color: s, borderDash: o, borderDashOffset: l, tickWidth: h, tickColor: d, tickBorderDash: u, tickBorderDashOffset: f }))
            }
        ...
        _layers() {
            ...
            return this._isVisible() && this.draw === zs.prototype.draw ? [{ z: i, draw: t => { this.drawBackground(), this.drawGrid(t), this.drawTitle() } }, { z: i + 1, draw: () => { this.drawBorder() } }, { z: e, draw: t => { this.drawLabels(t) } }] : [{ z: e, draw: t => { this.draw(t) } }]
        }
        ...
        _resolveTickFontOptions(t) { return We(this.options.ticks.setContext(this.getContext(t)).font) }
    ...
    var Bs = new class {
        constructor() { this.controllers = new Fs(ks, "datasets", !0), this.elements = new Fs(Ss, "elements"), this.plugins = new Fs(Object, "plugins"), this.scales = new Fs(zs, "scales"), this._typedRegistries = [this.controllers, this.scales, this.elements] }
    ...
    function Ws(t, e) { return e || !1 !== t ? !0 === t ? {} : t : null }
    ...
    function Hs(t, e) { const i = xt.datasets[t] || {}; return ((e.datasets || {})[t] || {}).indexAxis || e.indexAxis || i.indexAxis || "x" }

    function js(t, e) { return "x" === t || "y" === t ? t : e.axis || ("top" === (i = e.position) || "bottom" === i ? "x" : "left" === i || "right" === i ? "y" : void 0) || t.charAt(0).toLowerCase(); var i }
    ...
    function qs(t, e) { let i = Us.get(t); return i || (i = e(), Us.set(t, i), Xs.add(i)), i }
    const Ks = (t, e, i) => {
        const s = lt(e, i);
        void 0 !== s && t.add(s)
    };
    class Gs {
        constructor(t) { this._config = function(t) { return (t = t || {}).data = Ys(t.data), $s(t), t }(t), this._scopeCache = new Map, this._resolverCache = new Map }
        ...
        getOptionScopes(t, e, i) {
            ...
            if (a) return a;
            const r = new Set;
            e.forEach((e => { t && (r.add(t), e.forEach((e => Ks(r, t, e)))), e.forEach((t => Ks(r, s, t))), e.forEach((t => Ks(r, ft[n] || {}, t))), e.forEach((t => Ks(r, xt, t))), e.forEach((t => Ks(r, gt, t))) }));
        ...
        createResolver(t, e, i = [""], s) { const { resolver: n } = Zs(this._resolverCache, t, i); return U(e) ? ni(n, e, void 0, s) : n }
    }
    ...
    function Zs(t, e, i) {
        ...
        const n = i.join();
        let o = s.get(n);
        if (!o) { o = { resolver: si(e, i), subPrefixes: i.filter((t => !t.toLowerCase().includes("hover"))) }, s.set(n, o) }
        return o
    }
    const Qs = t => U(t) && Object.getOwnPropertyNames(t).reduce(((e, i) => e || dt(t[i])), !1);
    const Js = ["top", "bottom", "left", "right", "chartArea"];

    function tn(t, e) { return "top" === t || "bottom" === t || -1 === Js.indexOf(t) && "x" === e }

    function en(t, e) { return function(i, s) { return i[t] === s[t] ? i[e] - s[e] : i[t] - s[t] } }
    ...
    function on(t) { return fe() && "string" == typeof t ? t = document.getElementById(t) : t && t.length && (t = t[0]), t && t.canvas && (t = t.canvas), t }
    const an = {},
        rn = t => { const e = on(t); return Object.values(an).filter((t => t.canvas === e)).pop() };
    ...
    class hn {
        ...
        _initialize() { return this.notifyPlugins("beforeInit"), this.options.responsive ? this.resize() : Me(this, this.options.devicePixelRatio), this.bindEvents(), this.notifyPlugins("afterInit"), this }
        clear() { return Kt(this.canvas, this.ctx), this }
        ...
        buildOrUpdateScales() {
            ...
            e && (n = n.concat(Object.keys(e).map((t => {
                ...
                else { l = new(Bs.getScale(r))({ id: o, type: r, ctx: this.ctx, chart: this }), i[l.id] = l }
                l.init(n, t)
            })), J(s, ((t, e) => { t || delete i[e] })), J(i, (t => { ii.configure(this, t, t.options), ii.addBox(this, t) }))
        }
        _updateMetasets() {
        ...
        update(t) {
            ...
            o = this._minPadding = i.layout.autoPadding ? o : 0, this._updateLayout(o), s || J(n, (t => { t.reset() })), this._updateDatasets(t), this.notifyPlugins("afterUpdate", { mode: t }), this._layers.sort(en("z", "_idx")), this._lastEvent && this._eventHandler(this._lastEvent, !0), this.render()
        }
        _updateScales() { J(this.scales, (t => { ii.removeBox(this, t) })), this.ensureScalesHaveIDs(), this.buildOrUpdateScales() }
        _checkEventBindings() {
            const t = this.options,
        ...
        _updateHiddenIndices() {
            ...
            for (const { method: i, start: s, count: n }
                of e) { ln(t, s, "_removeElements" === i ? -n : n) }
        }
        ...
        render() {!1 !== this.notifyPlugins("beforeRender", { cancelable: !0 }) && (a.has(this) ? this.attached && !a.running(this) && a.start(this) : (this.draw(), sn({ chart: this }))) }
        draw() {
            let t;
        ...
        _drawDataset(t) {
            ...
            !1 !== this.notifyPlugins("beforeDatasetDraw", o) && (s && Qt(e, { left: !1 === i.left ? 0 : n.left - i.left, right: !1 === i.right ? this.width : n.right + i.right, top: !1 === i.top ? 0 : n.top - i.top, bottom: !1 === i.bottom ? this.height : n.bottom + i.bottom }), t.controller.draw(), s && Jt(e), o.cancelable = !1, this.notifyPlugins("afterDatasetDraw", o))
        }
        getElementsAtEventForMode(t, e, i, s) { const n = Le.modes[e]; return "function" == typeof n ? n(this, t, i, s) : [] }
        getDatasetMeta(t) {
        ...
        getContext() { return this.$context || (this.$context = je(null, { chart: this, type: "chart" })) }
    ...
    function un() { throw new Error("This method is not implemented: Check that a complete date adapter is provided.") }
    Object.defineProperties(hn, { defaults: { enumerable: dn, value: xt }, instances: { enumerable: dn, value: an }, overrides: { enumerable: dn, value: ft }, registry: { enumerable: dn, value: Bs }, version: { enumerable: dn, value: "3.6.2" }, getChart: { enumerable: dn, value: rn }, register: { enumerable: dn, value: (...t) => { Bs.add(...t), cn() } }, unregister: { enumerable: dn, value: (...t) => { Bs.remove(...t), cn() } } });
    class fn {
        constructor(t) { this.options = t || {} }
        formats() { return un() }
        parse(t, e) { return un() }
        format(t, e) { return un() }
        add(t, e, i) { return un() }
        diff(t, e, i) { return un() }
        startOf(t, e, i) { return un() }
        endOf(t, e) { return un() }
    }
    fn.override = function(t) { Object.assign(fn.prototype, t) };
    var gn = { _date: fn };
    ...
    function _n(t, e, i, s) { let n = e.borderSkipped; const o = {}; if (!n) return void(t.borderSkipped = o); const { start: a, end: r, reverse: l, top: h, bottom: c } = function(t) { let e, i, s, n, o; return t.horizontal ? (e = t.base > t.x, i = "left", s = "right") : (e = t.base < t.y, i = "bottom", s = "top"), e ? (n = "end", o = "start") : (n = "start", o = "end"), { start: i, end: s, reverse: e, top: n, bottom: o } }(t); "middle" === n && i && (t.enableBorderRadius = !0, (i._top || 0) === s ? n = h : (i._bottom || 0) === s ? n = c : (o[yn(c, a, r, l)] = !0, n = h)), o[yn(n, a, r, l)] = !0, t.borderSkipped = o }

    function yn(t, e, i, s) { var n, o, a; return s ? (a = i, t = vn(t = (n = t) === (o = e) ? a : n === a ? o : n, i, e)) : t = vn(t, e, i), t }

    function vn(t, e, i) { return "start" === t ? e : "end" === t ? i : t }

    function wn(t, { inflateAmount: e }, i) { t.inflateAmount = "auto" === e ? 1 === i ? .33 : 0 : e }
    class Mn extends ks {
        parsePrimitiveData(t, e, i, s) { return xn(t, e, i, s) }
        parseArrayData(t, e, i, s) { return xn(t, e, i, s) }
        parseObjectData(t, e, i, s) { const { iScale: n, vScale: o } = t, { xAxisKey: a = "x", yAxisKey: r = "y" } = this._parsing, l = "x" === n.axis ? a : r, h = "x" === o.axis ? a : r, c = []; let d, u, f, g; for (d = i, u = i + s; d < u; ++d) g = e[d], f = {}, f[n.axis] = n.parse(lt(g, l), d), c.push(mn(lt(g, h), f, o, d)); return c }
        updateRangeFromParsed(t, e, i, s) {
        ...
        updateElements(t, e, i, s) {
            ...
            for (let c = e; c < e + i; c++) {
                const e = this.getParsed(c),
                    ...
                    g = (e._stacks || {})[a.axis],
                    p = { horizontal: l, base: i.base, enableBorderRadius: !g || bn(e._custom) || o === g._top || o === g._bottom, x: l ? i.head : f.center, y: l ? f.center : i.head, height: l ? f.size : Math.abs(i.size), width: l ? Math.abs(i.size) : f.size };
        ...
        _getRuler() {
            ...
            return { min: a || pn(e), pixels: s, start: i._startPixel, end: i._endPixel, stackCount: this._getStackCount(), scale: i, grouped: t.grouped, ratio: a ? 1 : t.categoryPercentage * t.barPercentage }
        }
        _calculateBarValuePixels(t) {
            const { _cachedMeta: { vScale: e, _stacked: i }, options: { base: s, minBarLength: n } } = this, o = s || 0, a = this.getParsed(t), r = a._custom, l = bn(r);
            let h, c, d = a[e.axis],
                u = 0,
    ...
    Mn.id = "bar", Mn.defaults = { datasetElementType: !1, dataElementType: "bar", categoryPercentage: .8, barPercentage: .9, grouped: !0, animations: { numbers: { type: "number", properties: ["x", "y", "base", "width", "height"] } } }, Mn.overrides = { scales: { _index_: { type: "category", offset: !0, grid: { offset: !0 } }, _value_: { type: "linear", beginAtZero: !0 } } };
    class kn extends ks {
    ...
    kn.id = "bubble", kn.defaults = { datasetElementType: !1, dataElementType: "point", animations: { numbers: { type: "number", properties: ["x", "y", "borderWidth", "radius"] } } }, kn.overrides = { scales: { x: { type: "linear" }, y: { type: "linear" } }, plugins: { tooltip: { callbacks: { title: () => "" } } } };
    class Sn extends ks {
    ...
    Pn.id = "line", Pn.defaults = { datasetElementType: "line", dataElementType: "point", showLine: !0, spanGaps: !1 }, Pn.overrides = { scales: { _index_: { type: "category" }, _value_: { type: "linear" } } };
    class Dn extends ks {
    ...
    Dn.id = "polarArea", Dn.defaults = { dataElementType: "arc", animation: { animateRotate: !0, animateScale: !0 }, animations: { numbers: { type: "number", properties: ["x", "y", "startAngle", "endAngle", "innerRadius", "outerRadius"] } }, indexAxis: "r", startAngle: 0 }, Dn.overrides = { aspectRatio: 1, plugins: { legend: { labels: { generateLabels(t) { const e = t.data; if (e.labels.length && e.datasets.length) { const { labels: { pointStyle: i } } = t.legend.options; return e.labels.map(((e, s) => { const n = t.getDatasetMeta(0).controller.getStyle(s); return { text: e, fillStyle: n.backgroundColor, strokeStyle: n.borderColor, lineWidth: n.borderWidth, pointStyle: i, hidden: !t.getDataVisibility(s), index: s } })) } return [] } }, onClick(t, e, i) { i.chart.toggleDataVisibility(e.index), i.chart.update() } }, tooltip: { callbacks: { title: () => "", label: t => t.chart.data.labels[t.dataIndex] + ": " + t.formattedValue } } }, scales: { r: { type: "radialLinear", angleLines: { display: !1 }, beginAtZero: !0, grid: { circular: !0 }, pointLabels: { display: !1 }, startAngle: 0 } } };
    class Cn extends Sn {}
    ...
    On.id = "radar", On.defaults = { datasetElementType: "line", dataElementType: "point", indexAxis: "r", showLine: !0, elements: { line: { fill: "start" } } }, On.overrides = { aspectRatio: 1, scales: { r: { type: "radialLinear" } } };
    class An extends Pn {}
    An.id = "scatter", An.defaults = { showLine: !1, fill: !1 }, An.overrides = { interaction: { mode: "point" }, plugins: { tooltip: { callbacks: { title: () => "", label: t => "(" + t.label + ", " + t.formattedValue + ")" } } }, scales: { x: { type: "linear" }, y: { type: "linear" } } };
    var Tn = Object.freeze({ __proto__: null, BarController: Mn, BubbleController: kn, DoughnutController: Sn, LineController: Pn, PolarAreaController: Dn, PieController: Cn, RadarController: On, ScatterController: An });
    ...
    function En(t, e, i, s) { return { x: i + t * Math.cos(e), y: s + t * Math.sin(e) } }
    ...
    function zn(t, e, i, s, n) {
        ...
        o.borderWidth && (a ? (t.lineWidth = 2 * o.borderWidth, t.lineJoin = "round") : (t.lineWidth = o.borderWidth, t.lineJoin = "bevel"), e.fullCircles && function(t, e, i) { const { x: s, y: n, startAngle: o, pixelMargin: a, fullCircles: r } = e, l = Math.max(e.outerRadius - a, 0), h = e.innerRadius + a; let c; for (i && Ln(t, e, o + _t), t.beginPath(), t.arc(s, n, h, o + _t, o, !0), c = 0; c < r; ++c) t.stroke(); for (t.beginPath(), t.arc(s, n, l, o, o + _t), c = 0; c < r; ++c) t.stroke() }(t, e, a), a && Ln(t, e, n), In(t, e, i, s, n), t.stroke())
    }
    class Fn extends Ss {
    ...
    function Bn(t, e, i = e) { t.lineCap = K(i.borderCapStyle, e.borderCapStyle), t.setLineDash(K(i.borderDash, e.borderDash)), t.lineDashOffset = K(i.borderDashOffset, e.borderDashOffset), t.lineJoin = K(i.borderJoinStyle, e.borderJoinStyle), t.lineWidth = K(i.borderWidth, e.borderWidth), t.strokeStyle = K(i.borderColor, e.borderColor) }

    function Vn(t, e, i) { t.lineTo(i.x, i.y) }
    ...
    Fn.id = "arc", Fn.defaults = { borderAlign: "center", borderColor: "#fff", borderRadius: 0, borderWidth: 2, offset: 0, spacing: 0, angle: void 0 }, Fn.defaultRoutes = { backgroundColor: "backgroundColor" };
    ...
    function Yn(t, e, i, s) {
        ...
        }(t, e, i, s) : function(t, e, i, s) { const { segments: n, options: o } = e, a = jn(e); for (const r of n) Bn(t, o, r.style), t.beginPath(), a(t, e, r, { start: i, end: i + s - 1 }) && t.closePath(), t.stroke() }(t, e, i, s)
    }
    class Un extends Ss {
        ...
        get segments() { return this._segments || (this._segments = Vi(this, this.options.segment)) }
        first() {
        ...
        interpolate(t, e) {
            ...
            if (!o.length) return;
            const a = [],
                r = function(t) { return t.stepped ? Ci : t.tension || "monotone" === t.cubicInterpolationMode ? Oi : Di }(i);
            let l, h;
        ...
        pathSegment(t, e, i) { return jn(this)(t, this, e, i) }
        path(t, e, i) {
    ...
    Un.id = "line", Un.defaults = { borderCapStyle: "butt", borderDash: [], borderDashOffset: 0, borderJoinStyle: "miter", borderWidth: 3, capBezierPoints: !0, cubicInterpolationMode: "default", fill: !1, spanGaps: !1, stepped: !1, tension: 0 }, Un.defaultRoutes = { backgroundColor: "backgroundColor", borderColor: "borderColor" }, Un.descriptors = { _scriptable: !0, _indexable: t => "borderDash" !== t && "fill" !== t };
    class qn extends Ss {
        ...
        inXRange(t, e) { return Xn(this, t, "x", e) }
        inYRange(t, e) { return Xn(this, t, "y", e) }
    ...
    function Kn(t, e) { const { x: i, y: s, base: n, width: o, height: a } = t.getProps(["x", "y", "base", "width", "height"], e); let r, l, h, c, d; return t.horizontal ? (d = a / 2, r = Math.min(i, n), l = Math.max(i, n), h = s - d, c = s + d) : (d = o / 2, r = i - d, l = i + d, h = Math.min(s, n), c = Math.max(s, n)), { left: r, top: h, right: l, bottom: c } }

    function Gn(t, e, i, s) { return t ? 0 : Ht(e, i, s) }
    ...
    function Jn(t, e) { t.rect(e.x, e.y, e.w, e.h) }
    ...
    qn.id = "point", qn.defaults = { borderWidth: 1, hitRadius: 1, hoverBorderWidth: 1, hoverRadius: 4, pointStyle: "circle", radius: 3, rotation: 0 }, qn.defaultRoutes = { backgroundColor: "backgroundColor", borderColor: "borderColor" };
    class eo extends Ss {
        ...
        draw(t) {
            const { inflateAmount: e, options: { borderColor: i, backgroundColor: s } } = this, { inner: n, outer: o } = Zn(this), a = (r = o.radius).topLeft || r.topRight || r.bottomLeft || r.bottomRight ? ne : Jn;
            var r;
        ...
        inRange(t, e, i) { return Qn(this, t, e, i) }
        inXRange(t, e) { return Qn(this, t, null, e) }
        inYRange(t, e) { return Qn(this, null, t, e) }
    ...
    eo.id = "bar", eo.defaults = { borderSkipped: "start", borderWidth: 0, borderRadius: 0, inflateAmount: "auto", pointStyle: void 0 }, eo.defaultRoutes = { backgroundColor: "backgroundColor", borderColor: "borderColor" };
    ...
    function no(t) { t.data.datasets.forEach((t => { so(t) })) }
    var oo = {
        id: "decimation",
        ...
        beforeElementsUpdate: (t, e, i) => {
            ...
            t.data.datasets.forEach(((e, n) => {
                ...
                let { start: c, count: d } = function(t, e) { const i = e.length; let s, n = 0; const { iScale: o } = t, { min: a, max: r, minDefined: l, maxDefined: h } = o.getUserBounds(); return l && (n = Ht(ae(e, o.axis, a).lo, 0, i - 1)), s = h ? Ht(ae(e, o.axis, r).hi + 1, n, i) - n : i - n, { start: n, count: s } }(r, l);
    ...
    function lo(t) { return (t.scale || {}).getPointPositionForValue ? function(t) { const { scale: e, fill: i } = t, s = e.options, n = e.getLabels().length, o = [], a = s.reverse ? e.max : e.min, r = s.reverse ? e.min : e.max; let l, h, c; if (c = "start" === i ? a : "end" === i ? r : U(i) ? i.value : e.getBaseValue(), s.grid.circular) return h = e.getPointPositionForValue(0, a), new ro({ x: h.x, y: h.y, radius: e.getDistanceFromCenterForValue(c) }); for (l = 0; l < n; ++l) o.push(e.getPointPositionForValue(l, c)); return o }(t) : function(t) { const { scale: e = {}, fill: i } = t; let s, n = null; return "start" === i ? n = e.bottom : "end" === i ? n = e.top : U(i) ? n = e.getPixelForValue(i.value) : e.getBasePixel && (n = e.getBasePixel()), X(n) ? (s = e.isHorizontal(), { x: s ? n : null, y: s ? null : n }) : null }(t) }

    function ho(t, e, i) { for (; e > t; e--) { const t = i[e]; if (!isNaN(t.x) && !isNaN(t.y)) break } return e }
    ...
    function fo(t) {
        ...
        if ("stack" === i) return function(t) {
            ...
            for (let t = 0; t < o.length; t++) { const e = o[t]; for (let t = e.start; t <= e.end; t++) co(n, a[t], r) }
    ...
    function mo(t, e, i) { t.beginPath(), e.path(t), t.lineTo(e.last().x, i), t.lineTo(e.first().x, i), t.closePath(), t.clip() }
    ...
    function _o(t, e, i) { const { top: s, bottom: n } = e.chart.chartArea, { property: o, start: a, end: r } = i || {}; "x" === o && (t.beginPath(), t.rect(a, s, r - a, n - s), t.clip()) }
    ...
    function wo(t, e, i) {
        ...
        s && n.points.length && (Qt(t, i), function(t, e) {
            ...
            t.save(), "x" === l && o !== n && (mo(t, s, a.top), vo(t, { line: i, target: s, color: n, scale: r, property: l }), t.restore(), t.save(), mo(t, s, a.bottom)), vo(t, { line: i, target: s, color: o, scale: r, property: l }), t.restore()
    ...
    var Mo = {
        ...
        afterDatasetsUpdate(t, e, i) {
            const s = (t.data.datasets || []).length,
                n = [];
            let o, a, r, l;
            for (a = 0; a < s; ++a) o = t.getDatasetMeta(a), r = o.dataset, l = null, r && r.options && r instanceof Un && (l = { visible: t.isDatasetVisible(a), index: a, fill: ao(r, a, s), chart: t, axis: o.controller.options.indexAxis, scale: o.vScale, line: r }), o.$filler = l, n.push(l);
    ...
    const ko = (t, e) => { let { boxHeight: i = e, boxWidth: s = e } = t; return t.usePointStyle && (i = Math.min(i, e), s = Math.min(s, e)), { boxWidth: s, boxHeight: i, itemHeight: Math.max(e, i) } };
    class So extends Ss {
        ...
        _draw() {
            const { options: t, columnSizes: e, lineWidths: i, ctx: s } = this, { align: a, labels: r } = t, l = xt.color, h = Li(t.rtl, this.left, this.width), c = We(r.font), { color: d, padding: u } = r, f = c.size, g = f / 2;
            let p;
            this.drawTitle(), s.textAlign = h.textAlign("left"), s.textBaseline = "middle", s.lineWidth = .5, s.font = c.string;
            const { boxWidth: m, boxHeight: x, itemHeight: b } = ko(r, f), _ = this.isHorizontal(), y = this._computeTitleHeight();
            p = _ ? { x: n(a, this.left + u, this.right - i[0]), y: this.top + u + y, line: 0 } : { x: this.left + u, y: n(a, this.top + y + u, this.bottom - e[0].height), line: 0 }, Ri(this.ctx, t.textDirection);
            const v = b + u;
            this.legendItems.forEach(((w, M) => {
                ...
                ! function(t, e, i) {
                    ...
                    function(t, e, i) { ie(s, i.text, t, e + b / 2, c, { strikethrough: i.hidden, textAlign: h.textAlign(i.textAlign) }) }(h.x(D), C, w), _ ? p.x += P + u : p.y += v
    ...
    var Po = {
        ...
        stop(t) { ii.removeBox(t, t.legend), delete t.legend },
        beforeUpdate(t, e, i) {
            const s = t.legend;
    ...
    var Ao = {
        ...
        stop(t) { ii.removeBox(t, Oo.get(t)), Oo.delete(t) },
        beforeUpdate(t, e, i) {
            const s = Oo.get(t);
            ii.configure(t, s, i), s.options = i
        },
    ...
    function Lo(t, e) { return e && (Y(e) ? Array.prototype.push.apply(t, e) : t.push(e)), t }

    function Ro(t) { return ("string" == typeof t || t instanceof String) && t.indexOf("\n") > -1 ? t.split("\n") : t }

    function Eo(t, e) { const { element: i, datasetIndex: s, index: n } = e, o = t.getDatasetMeta(s).controller, { label: a, value: r } = o.getLabelAndValue(n); return { chart: t, label: a, parsed: o.getParsed(n), raw: t.data.datasets[s].data[n], formattedValue: r, dataset: o.getDataset(), dataIndex: n, datasetIndex: s, element: i } }
    ...
    function Fo(t, e, i) { const s = e.yAlign || function(t, e) { const { y: i, height: s } = e; return i < s / 2 ? "top" : i > t.height - s / 2 ? "bottom" : "center" }(t, i); return { xAlign: e.xAlign || zo(t, e, i, s), yAlign: s } }

    function Bo(t, e, i, s) { const { caretSize: n, caretPadding: o, cornerRadius: a } = t, { xAlign: r, yAlign: l } = i, h = n + o, { topLeft: c, topRight: d, bottomLeft: u, bottomRight: f } = Be(a); let g = function(t, e) { let { x: i, width: s } = t; return "right" === e ? i -= s : "center" === e && (i -= s / 2), i }(e, r); const p = function(t, e, i) { let { y: s, height: n } = t; return "top" === e ? s += i : s -= "bottom" === e ? n + i : n / 2, s }(e, l, h); return "center" === l ? "left" === r ? g += h : "right" === r && (g -= h) : "left" === r ? g -= Math.max(c, u) + n : "right" === r && (g += Math.max(d, f) + n), { x: Ht(g, 0, s.width - e.width), y: Ht(p, 0, s.height - e.height) } }

    function Vo(t, e, i) { const s = Ve(i.padding); return "center" === e ? t.x + t.width / 2 : "right" === e ? t.x + t.width - s.right : t.x + s.left }

    function Wo(t) { return Lo([], Ro(t)) }

    function No(t, e) { const i = e && e.dataset && e.dataset.tooltip && e.dataset.tooltip.callbacks; return i ? t.override(i) : t }
    class Ho extends Ss {
        ...
        getContext() { return this.$context || (this.$context = (t = this._chart.getContext(), e = this, i = this._tooltipItems, je(t, { tooltip: e, tooltipItems: i, type: "tooltip" }))); var t, e, i }
        getTitle(t, e) { const { callbacks: i } = e, s = i.beforeTitle.apply(this, [t]), n = i.title.apply(this, [t]), o = i.afterTitle.apply(this, [t]); let a = []; return a = Lo(a, Ro(s)), a = Lo(a, Ro(n)), a = Lo(a, Ro(o)), a }
        getBeforeBody(t, e) { return Wo(e.callbacks.beforeBody.apply(this, [t])) }
        getBody(t, e) {
        ...
        getAfterBody(t, e) { return Wo(e.callbacks.afterBody.apply(this, [t])) }
        getFooter(t, e) { const { callbacks: i } = e, s = i.beforeFooter.apply(this, [t]), n = i.footer.apply(this, [t]), o = i.afterFooter.apply(this, [t]); let a = []; return a = Lo(a, Ro(s)), a = Lo(a, Ro(n)), a = Lo(a, Ro(o)), a }
        _createItems(t) {
            const e = this._active,
                i = this._chart.data,
                s = [],
        ...
        getCaretPosition(t, e, i) { const { xAlign: s, yAlign: n } = this, { caretSize: o, cornerRadius: a } = i, { topLeft: r, topRight: l, bottomLeft: h, bottomRight: c } = Be(a), { x: d, y: u } = t, { width: f, height: g } = e; let p, m, x, b, _, y; return "center" === n ? (_ = u + g / 2, "left" === s ? (p = d, m = p - o, b = _ + o, y = _ - o) : (p = d + f, m = p + o, b = _ - o, y = _ + o), x = p) : (m = "left" === s ? d + Math.max(r, h) + o : "right" === s ? d + f - Math.max(l, c) - o : this.caretX, "top" === n ? (b = u, _ = b - o, p = m - o, x = m + o) : (b = u + g, _ = b + o, p = m + o, x = m - o), y = b), { x1: p, x2: m, x3: x, y1: b, y2: _, y3: y } }
        drawTitle(t, e, i) {
            const s = this.title,
                n = s.length;
            let o, a, r;
            if (n) { const l = Li(i.rtl, this.x, this.width); for (t.x = Vo(this, i.titleAlign, i), e.textAlign = l.textAlign(i.titleAlign), e.textBaseline = "middle", o = We(i.titleFont), a = i.titleSpacing, e.fillStyle = i.titleColor, e.font = o.string, r = 0; r < n; ++r) e.fillText(s[r], l.x(t.x), t.y + o.lineHeight / 2), t.y += o.lineHeight + a, r + 1 === n && (t.y += i.titleMarginBottom - a) }
        }
        _drawColorBox(t, e, i, s, n) {
            ...
            if (n.usePointStyle) {
                ...
                const e = s.leftForLtr(u, l - h),
                    ...
                    a = Be(o.borderRadius);
                Object.values(a).some((t => 0 !== t)) ? (t.beginPath(), t.fillStyle = n.multiKeyBackground, ne(t, { x: e, y: g, w: l, h: r, radius: a }), t.fill(), t.stroke(), t.fillStyle = o.backgroundColor, t.beginPath(), ne(t, { x: i, y: g + 1, w: l - 2, h: r - 2, radius: a }), t.fill()) : (t.fillStyle = n.multiKeyBackground, t.fillRect(e, g, l, r), t.strokeRect(e, g, l, r), t.fillStyle = o.backgroundColor, t.fillRect(i, g + 1, l - 2, r - 2))
            }
            t.fillStyle = this.labelTextColors[i]
        }
        drawBody(t, e, i) {
            const { body: s } = this, { bodySpacing: n, bodyAlign: o, displayColors: a, boxHeight: r, boxWidth: l, boxPadding: h } = i, c = We(i.bodyFont);
            let d = c.lineHeight,
                u = 0;
        ...
        drawFooter(t, e, i) {
            const s = this.footer,
                n = s.length;
            let o, a;
            if (n) { const r = Li(i.rtl, this.x, this.width); for (t.x = Vo(this, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = r.textAlign(i.footerAlign), e.textBaseline = "middle", o = We(i.footerFont), e.fillStyle = i.footerColor, e.font = o.string, a = 0; a < n; ++a) e.fillText(s[a], r.x(t.x), t.y + o.lineHeight / 2), t.y += o.lineHeight + i.footerSpacing }
        }
        ...
        _positionChanged(t, e) { const { caretX: i, caretY: s, options: n } = this, o = To[n.position].call(this, t, e); return !1 !== o && (i !== o.x || s !== o.y) }
    }
    Ho.positioners = To;
    var jo = {
            id: "tooltip",
            _element: Ho,
            positioners: To,
            afterInit(t, e, i) { i && (t.tooltip = new Ho({ _chart: t, options: i })) },
    ...
    function Yo(t, e, i, s) { const n = t.indexOf(e); if (-1 === n) return ((t, e, i, s) => ("string" == typeof e ? (i = t.push(e) - 1, s.unshift({ index: i, label: e })) : isNaN(e) && (i = null), i))(t, e, i, s); return n !== t.lastIndexOf(e) ? i : n }
    class Uo extends zs {
        ...
        parse(t, e) { if ($(t)) return null; const i = this.getLabels(); return ((t, e) => null === t ? null : Ht(Math.round(t), 0, e))(e = isFinite(e) && i[e] === t ? e : Yo(i, t, K(e, t), this._addedLabels), i.length - 1) }
    ...
    class qo extends zs {
        ...
        getLabelForValue(t) { return Ti(t, this.chart.options.locale, this.options.ticks.format) }
    }
    class Ko extends qo {
        determineDataLimits() {
    ...
    function Go(t) { return 1 === t / Math.pow(10, Math.floor(Pt(t))) }
    ...
    class Zo extends zs {
        ...
        buildTicks() {
            const t = this.options,
                e = function(t, e) {
                    ...
                    do { n.push({ value: o, major: Go(o) }), ++r, 10 === r && (r = 1, ++a, l = a >= 0 ? 1 : l), o = Math.round(r * Math.pow(10, a) * l) / l } while (a < i || a === i && r < s);
                    const h = q(t.max, o);
        ...
        getLabelForValue(t) { return void 0 === t ? "0" : Ti(t, this.chart.options.locale, this.options.ticks.format) }
        configure() {
            const t = this.min;
    ...
    function Qo(t) { const e = t.ticks; if (e.display && t.display) { const t = Ve(e.backdropPadding); return K(e.font && e.font.size, xt.font.size) + t.height } return 0 }

    function Jo(t, e, i, s, n) { return t === s || t === n ? { start: e - i / 2, end: e + i / 2 } : t < s || t > n ? { start: e - i, end: e } : { start: e, end: e + i } }
    ...
    function ea(t) { return 0 === t || 180 === t ? "center" : t < 180 ? "left" : "right" }

    function ia(t, e, i) { return "right" === i ? t -= e : "center" === i && (t -= e / 2), t }

    function sa(t, e, i) { return 90 === i || 270 === i ? t -= e / 2 : (i > 270 || i < 90) && (t -= e), t }
    ...
    class aa extends qo {
        ...
        setDimensions() { this.width = this.maxWidth, this.height = this.maxHeight, this.paddingTop = Qo(this.options) / 2, this.xCenter = Math.floor(this.width / 2), this.yCenter = Math.floor((this.height - this.paddingTop) / 2), this.drawingArea = Math.min(this.height - this.paddingTop, this.width) / 2 }
        determineDataLimits() {
            const { min: t, max: e } = this.getMinMax(!1);
            this.min = X(t) && !isNaN(t) ? t : 0, this.max = X(e) && !isNaN(e) ? e : 0, this.handleTickRangeOptions()
        }
        computeTickLimit() { return Math.ceil(this.drawingArea / Qo(this.options)) }
        generateTickLabels(t) { qo.prototype.generateTickLabels.call(this, t), this._pointLabels = this.getLabels().map(((t, e) => { const i = Q(this.options.pointLabels.callback, [t, e], this); return i || 0 === i ? i : "" })) }
        fit() {
            const t = this.options;
        ...
        getPointLabelContext(t) { const e = this._pointLabels || []; if (t >= 0 && t < e.length) { const i = e[t]; return function(t, e, i) { return je(t, { label: i, index: e, type: "pointLabel" }) }(this.getContext(), t, i) } }
    ...
    class ga extends zs {
        ...
        parse(t, e) { return void 0 === t ? null : ca(this, t) }
        ...
        buildTicks() {
            ...
            const n = this.min,
                o = le(s, n, this.max);
            return this._unit = e.unit || (i.autoSkip ? da(e.minUnit, this.min, this.max, this._getLabelCapacity(n)) : function(t, e, i, s, n) { for (let o = la.length - 1; o >= la.indexOf(i); o--) { const i = la[o]; if (ra[i].common && t._adapter.diff(n, s, i) >= e - 1) return i } return la[i ? la.indexOf(i) : 0] }(this, o.length, e.minUnit, this.min, this.max)), this._majorUnit = i.major.enabled && "year" !== this._unit ? function(t) {
        ...
        getLabelTimestamps() { const t = this._cache.labels || []; let e, i; if (t.length) return t; const s = this.getLabels(); for (e = 0, i = s.length; e < i; ++e) t.push(ca(this, s[e])); return this._cache.labels = this._normalized ? t : this.normalize(t) }
        normalize(t) { return ue(t.sort(ha)) }
    }

    function pa(t, e, i) {
        let s, n, o, a, r = 0,
            l = t.length - 1;
        i ? (e >= t[r].pos && e <= t[l].pos && ({ lo: r, hi: l } = ae(t, "pos", e)), ({ pos: s, time: o } = t[r]), ({ pos: n, time: a } = t[l])) : (e >= t[r].time && e <= t[l].time && ({ lo: r, hi: l } = ae(t, "time", e)), ({ time: s, pos: o } = t[r]), ({ time: n, pos: a } = t[l]));
        const h = n - s;
        return h ? o + (a - o) * (e - s) / h : o
    }
    ga.id = "time", ga.defaults = { bounds: "data", adapters: {}, time: { parser: !1, unit: !1, round: !1, isoWeekday: !1, minUnit: "millisecond", displayFormats: {} }, ticks: { source: "auto", major: { enabled: !1 } } };
    class ma extends ga {
        ...
        getDecimalForValue(t) { return (pa(this._table, t) - this._minPos) / this._tableRange }
        getValueForPixel(t) {
            const e = this._offsets,
                i = this.getDecimalForPixel(t) / e.factor - e.end;
